...
namespace Component
{
    public class CharacterMovement : CharacterComponents
    {
        ...
        // Internal
        private readonly int _movingParamater = Animator.StringToHash("Moving");
        ...
        private void UpdateAnimations()
        {
            ...
            {
                animator.SetBool(_movingParamater, value: true);
            }
            else
            {
                animator.SetBool(_movingParamater, value: false);
            }
        }
